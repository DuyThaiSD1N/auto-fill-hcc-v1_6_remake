...
# Hồ sơ mẫu trace req_0e37edf34a33: chủ hồ sơ là công ty, người đại diện pháp luật có CCCD trên ĐKKD,
# thành viên góp vốn thứ hai cũng có số định danh.
_FACTS = [
    {"name": "ChuHoSo_LaToChuc", "value": True},
    {"name": "ChuHoSo_TenToChuc", "value": "CÔNG TY TNHH ĐẦU TƯ NĂNG LƯỢNG 159"},
    {"name": "ChuHoSo_MaSoThue", "value": "5300727490"},
    {"name": "ChuHoSo_NoiCuTru",
     "value": {"tinh": "Lào Cai", "xa": "Phường Lào Cai", "diaChi": "Số 177 Phan Chu Trinh"}},
    {"name": "NguoiTrongGiayTo", "value": [
        {"HoTen": "ĐỖ XUÂN THÀNH", "SoDinhDanh": "035066009759", "NgaySinh": "06/12/1966",
         ...
         "NoiCuTru": {"tinh": "Lào Cai", "xa": "Phường Lào Cai", "diaChi": "Số nhà 194, phố Soi Tiền"}},
        {"HoTen": "ĐỖ THỊ HẢI YẾN", "SoDinhDanh": "035190009041",
         "NoiCuTru": {"tinh": "Lào Cai", "xa": "Phường Lào Cai", "diaChi": "Tổ 27"}},
    ]},
...
def test_che_do_tai_khoan_khong_co_moc_thi_bo_trong_ca_khoi():
    ...
    assert values["ChuHoSo_tenCoQuanToChucCHS"] == "CÔNG TY TNHH ĐẦU TƯ NĂNG LƯỢNG 159"
...
def test_che_do_tai_khoan_co_moc_nhung_ho_so_khong_co_giay_to_cua_nguoi_do():
    ...
    assert values["CongDan_tenCoQuanToChuc"] == "CÔNG TY TNHH ĐẦU TƯ NĂNG LƯỢNG 159"
...
def test_che_do_to_khai_uu_tien_ben_duoc_uy_quyen():
    facts = _FACTS + [
        {"name": "NguoiDuocUyQuyen", "value": {
            ...
            "thuongTru": {"tinh": "Lào Cai", "xa": "Phường Lào Cai", "diaChi": "Số 5"},
        }},
    ]
