...
var e = /* @__PURE__ */ ((e) => typeof require < "u" ? require : typeof Proxy < "u" ? new Proxy(e, { get: (e, t) => (typeof require < "u" ? require : e)[t] }) : e)(function(e) {
...
}), t, n, r, i, a, o, s, c, l, u, d, f, p, m, h, g, _, v, y, b, x, S, C, ee, w, T, E, te, D, O, k, A, ne, re, j = /* @__PURE__ */ ((t) => e === void 0 ? typeof Proxy < "u" ? new Proxy(t, { get: (t, n) => (e === void 0 ? t : e)[n] }) : t : e)(function(t) {
...
}), ie = Object.defineProperty, ae = Object.getOwnPropertyDescriptor, oe = Object.getOwnPropertyNames, se = Object.prototype.hasOwnProperty, ce = (t = function(e) {
	if (typeof j < "u") return j.apply(this, arguments);
	throw Error("Dynamic require of \"" + e + "\" is not supported");
}, typeof j < "u" ? j : typeof Proxy < "u" ? new Proxy(t, { get: (e, t) => (typeof j < "u" ? j : e)[t] }) : t), M = (e, t) => () => (e && (t = e(e = 0)), t), le = (e, t) => {
	for (var n in t) ie(e, n, {
		get: t[n],
		enumerable: !0
	});
}, ue = (e) => ((e, t, n, r) => {
	if (t && typeof t == "object" || typeof t == "function") for (let i of oe(t)) !se.call(e, i) && i !== n && ie(e, i, {
		get: () => t[i],
		enumerable: !(r = ae(t, i)) || r.enumerable
	});
	return e;
})(ie({}, "__esModule", { value: !0 }), e), de = M(() => {
	n = /* @__PURE__ */ new Map(), r = [], i = (e, t, i) => {
		if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
			...
			if (a === void 0) n.set(e, {
				...
				if (a.priority > i) return;
				if (a.priority === i && a.backend !== t) throw Error(`cannot register backend "${e}" using priority ${i}`);
			}
			if (i >= 0) {
				let t = r.indexOf(e);
				t !== -1 && r.splice(t, 1);
				for (let t = 0; t < r.length; t++) if (n.get(r[t]).priority <= i) return void r.splice(t, 0, e);
				r.push(e);
			}
			return;
		}
		...
		let t, n = e.executionProviders || [], i = n.map((e) => typeof e == "string" ? e : e.name), o = i.length === 0 ? r : i, s = [], c = /* @__PURE__ */ new Set();
		for (let e of o) {
			let n = await a(e);
		...
		if (!t) throw Error(`no available backend found. ERR: ${s.map((e) => `[${e.name}] ${e.err}`).join(", ")}`);
		for (let { name: e, err: t } of s) i.includes(e);
		let l = n.filter((e) => c.has(typeof e == "string" ? e : e.name));
		return [t, new Proxy(e, { get: (e, t) => t === "executionProviders" ? l : Reflect.get(e, t) })];
	};
}), fe = M(() => {
	de();
}), pe = M(() => {
	...
	d = (e, t) => {
		...
		if (r != null) {
			...
			let o, s, c = t?.format === void 0 ? "RGB" : t.format, l = t?.norm;
			l === void 0 || l.mean === void 0 ? o = [
				255,
				255,
				255,
				255
			] : typeof l.mean == "number" ? o = [
				l.mean,
				l.mean,
				l.mean,
				l.mean
				...
				l.mean[2],
				0
			], l.mean[3] !== void 0 && (o[3] = l.mean[3])), l === void 0 || l.bias === void 0 ? s = [
				0,
				0,
				0,
				0
			] : typeof l.bias == "number" ? s = [
				l.bias,
				l.bias,
				l.bias,
				l.bias
				...
				l.bias[2],
				0
			], l.bias[3] !== void 0 && (s[3] = l.bias[3]));
			let u = a * i, d = 0, f = u, p = 2 * u, m = -1;
			c === "RGBA" ? (d = 0, f = u, p = 2 * u, m = 3 * u) : c === "RGB" ? (d = 0, f = u, p = 2 * u) : c === "RBG" && (d = 0, p = u, f = 2 * u);
			for (let t = 0; t < a; t++) for (let n = 0; n < i; n++) {
				let i = (e.data[d++] - s[0]) * o[0], a = (e.data[f++] - s[1]) * o[1], c = (e.data[p++] - s[2]) * o[2], l = m === -1 ? 255 : (e.data[m++] - s[3]) * o[3];
				r.fillStyle = "rgba(" + i + "," + a + "," + c + "," + l + ")", r.fillRect(n, t, 1, 1);
			}
		...
		let n, r = typeof document < "u" ? document.createElement("canvas").getContext("2d") : new OffscreenCanvas(1, 1).getContext("2d");
		if (r == null) throw Error("Can not access image data");
		{
			...
			let s, c, l = t !== void 0 && t.format !== void 0 ? t.format : "RGB", u = t?.norm;
			u === void 0 || u.mean === void 0 ? s = [
				255,
				255,
				255,
				255
			] : typeof u.mean == "number" ? s = [
				u.mean,
				u.mean,
				u.mean,
				u.mean
				...
				u.mean[2],
				255
			], u.mean[3] !== void 0 && (s[3] = u.mean[3])), u === void 0 || u.bias === void 0 ? c = [
				0,
				0,
				0,
				0
			...
			let f = 0, p = 1, m = 2, h = 3, g = 0, _ = d, v = 2 * d, y = -1;
			l === "RGBA" ? (g = 0, _ = d, v = 2 * d, y = 3 * d) : l === "RGB" ? (g = 0, _ = d, v = 2 * d) : l === "RBG" && (g = 0, v = d, _ = 2 * d), n = r.createImageData(i, a);
			for (let t = 0; t < a * i; f += 4, p += 4, m += 4, h += 4, t++) n.data[f] = (e.data[g++] - c[0]) * s[0], n.data[p] = (e.data[_++] - c[1]) * s[1], n.data[m] = (e.data[v++] - c[2]) * s[2], n.data[h] = y === -1 ? 255 : (e.data[y++] - c[3]) * s[3];
		}
		return n;
	};
}), _e = M(() => {
	be(), p = (e, t) => {
		...
		let n, r, { height: i, width: a } = t, o = t.norm ?? {
			mean: 255,
			bias: 0
		};
		n = typeof o.mean == "number" ? [
			o.mean,
			o.mean,
			o.mean,
			o.mean
		...
		let s = t.format === void 0 ? "RGBA" : t.format, c = t.tensorFormat !== void 0 && t.tensorFormat !== void 0 ? t.tensorFormat : "RGB", l = i * a, u = c === "RGBA" ? new Float32Array(4 * l) : new Float32Array(3 * l), d = 4, f = 0, p = 1, m = 2, h = 3, g = 0, _ = l, v = 2 * l, y = -1;
		s === "RGB" && (d = 3, f = 0, p = 1, m = 2, h = -1), c === "RGBA" ? y = 3 * l : c === "RBG" ? (g = 0, v = l, _ = 2 * l) : c === "BGR" && (v = 0, _ = l, g = 2 * l);
		for (let t = 0; t < l; t++, f += d, m += d, p += d, h += d) u[g++] = (e[f] + r[0]) / n[0], u[_++] = (e[p] + r[1]) / n[1], u[v++] = (e[m] + r[2]) / n[2], y !== -1 && h !== -1 && (u[y++] = (e[h] + r[3]) / n[3]);
		return new w("float32", u, c === "RGBA" ? [
			1,
			4,
			i,
			a
		...
		let n, r = typeof HTMLImageElement < "u" && e instanceof HTMLImageElement, i = typeof ImageData < "u" && e instanceof ImageData, a = typeof ImageBitmap < "u" && e instanceof ImageBitmap, o = typeof e == "string", s = t ?? {}, c = () => {
		...
		if (r) {
			...
			let i = l(r);
			if (i == null) throw Error("Can not access image data");
			{
				let r = e.height, a = e.width;
				if (t !== void 0 && t.resizedHeight !== void 0 && t.resizedWidth !== void 0 && (r = t.resizedHeight, a = t.resizedWidth), t !== void 0) {
					if (s = t, t.tensorFormat !== void 0) throw Error("Image input config format must be RGBA for HTMLImageElement");
					s.tensorFormat = "RGBA", s.height = r, s.width = a;
				} else s.tensorFormat = "RGBA", s.height = r, s.width = a;
				i.drawImage(e, 0, 0), n = i.getImageData(0, 0, a, r).data;
			}
		} else {
			if (!i) {
				if (a) {
					...
					let i = l(r);
					if (i != null) {
						let t = e.height, r = e.width;
						return i.drawImage(e, 0, 0, r, t), n = i.getImageData(0, 0, r, t).data, s.height = t, s.width = r, p(n, s);
					}
					throw Error("Can not access image data");
				}
				if (o) return new Promise((t, n) => {
					...
					a.crossOrigin = "Anonymous", a.src = e, a.onload = () => {
						...
						s.height = r.height, s.width = r.width, t(p(e.data, s));
					};
				});
			...
			{
				let r, i;
				if (t !== void 0 && t.resizedWidth !== void 0 && t.resizedHeight !== void 0 ? (r = t.resizedHeight, i = t.resizedWidth) : (r = e.height, i = e.width), t !== void 0 && (s = t), s.format = "RGBA", s.height = r, s.width = i, t !== void 0) {
					let t = c();
					t.width = i, t.height = r;
					let a = l(t);
					if (a == null) throw Error("Can not access image data");
					a.putImageData(e, 0, 0), n = a.getImageData(0, 0, i, r).data;
				} else n = e.data;
			}
		}
		if (n !== void 0) return p(n, s);
		throw Error("Input data provided is not supported - aborted tensor creation");
	}, h = (e, t) => {
	...
	y = /* @__PURE__ */ new Map([
		...
		if (!x) {
			...
			e && (y.set("int64", BigInt64Array), b.set(BigInt64Array, "int64")), t && (y.set("uint64", BigUint64Array), b.set(BigUint64Array, "uint64")), r ? (y.set("float16", n), b.set(n, "float16")) : y.set("float16", Uint16Array);
		}
	};
}), ye = M(() => {
	be(), C = (e) => {
		...
		switch (e.location) {
			case "cpu": return new w(e.type, e.data, t);
			case "cpu-pinned": return new w({
				location: "cpu-pinned",
				data: e.data,
				type: e.type,
				dims: t
			});
			case "texture": return new w({
				location: "texture",
				texture: e.texture,
				type: e.type,
				dims: t
			});
			case "gpu-buffer": return new w({
				location: "gpu-buffer",
				gpuBuffer: e.gpuBuffer,
				type: e.type,
				dims: t
			});
			case "ml-tensor": return new w({
				location: "ml-tensor",
				mlTensor: e.mlTensor,
				type: e.type,
				dims: t
	...
	ge(), _e(), ve(), ye(), w = class {
		constructor(e, t, n) {
			let r, i;
			if (S(), typeof e == "object" && "location" in e) switch (this.dataLocation = e.location, r = e.type, i = e.dims, e.location) {
				case "cpu-pinned": {
					let t = y.get(r);
				...
				if (typeof e == "string") {
					if (r = e, o = n, e === "string") {
						...
						if (Array.isArray(t)) {
							...
							if (e !== "uint8") throw TypeError("A Uint8ClampedArray tensor's data must be type of uint8");
							a = Uint8Array.from(t);
						} else {
							if (!(e === "float16" && t instanceof Uint16Array && n !== Uint16Array)) throw TypeError(`A ${r} tensor's data must be type of ${n}`);
	...
	me(), E = (e, t) => {
		typeof l.trace > "u" ? l.wasm.trace : l.trace;
	}, te = (e, t) => {
		let n = /* @__PURE__ */ (/* @__PURE__ */ Error()).stack?.split(/\r\n|\r|\n/g) || [], r = !1;
		...
		(typeof l.trace > "u" ? !l.wasm.trace : !l.trace) || te("BEGIN", e);
	}, O = (e) => {
		(typeof l.trace > "u" ? !l.wasm.trace : !l.trace) || te("END", e);
	}, k = (e) => {
		typeof l.trace > "u" ? l.wasm.trace : l.trace;
	}, A = (e) => {
		typeof l.trace > "u" ? l.wasm.trace : l.trace;
	...
	de(), xe(), Se(), ne = class e {
		...
		async run(e, t, n) {
			D(), k("InferenceSession.run");
			let r = {}, i = {};
			if (typeof e != "object" || !e || e instanceof T || Array.isArray(e)) throw TypeError("'feeds' must be an object that use input names as keys and OnnxValue as corresponding values.");
			let a = !0;
			if (typeof t == "object") {
				if (t === null) throw TypeError("Unexpected argument[1]: cannot be null.");
				if (t instanceof T) throw TypeError("'fetches' cannot be a Tensor");
				if (Array.isArray(t)) {
					...
					for (let n of this.outputNames) if (o.indexOf(n) !== -1) {
						let i = t[n];
						(i === null || i instanceof T) && (e = !0, a = !1, r[n] = i);
					}
					if (e) {
						if (typeof n == "object" && n) i = n;
						else if (typeof n < "u") throw TypeError("'options' must be an object.");
			...
			for (let e in o) if (Object.hasOwnProperty.call(o, e)) {
				let t = o[e];
				s[e] = t instanceof T ? t : new T(t.type, t.data, t.dims);
			}
			return A("InferenceSession.run"), O(), s;
		}
		async release() {
			return this.handler.dispose();
		}
		static async create(t, n, r, i) {
			D(), k("InferenceSession.create");
			let a, s = {};
			if (typeof t == "string") {
				if (a = t, typeof n == "object" && n) s = n;
				else if (typeof n < "u") throw TypeError("'options' must be an object.");
			} else if (t instanceof Uint8Array) {
				if (a = t, typeof n == "object" && n) s = n;
				else if (typeof n < "u") throw TypeError("'options' must be an object.");
			} else {
				if (!(t instanceof ArrayBuffer || typeof SharedArrayBuffer < "u" && t instanceof SharedArrayBuffer)) throw TypeError("Unexpected argument[0]: must be 'path' or 'buffer'.");
				{
					let e = t, o = 0, c = t.byteLength;
					if (typeof n == "object" && n) s = n;
					else if (typeof n == "number") {
						if (o = n, !Number.isSafeInteger(o)) throw RangeError("'byteOffset' must be an integer.");
						if (o < 0 || o >= e.byteLength) throw RangeError(`'byteOffset' is out of range [0, ${e.byteLength}).`);
						if (c = t.byteLength - o, typeof r == "number") {
							if (c = r, !Number.isSafeInteger(c)) throw RangeError("'byteLength' must be an integer.");
							if (c <= 0 || o + c > e.byteLength) throw RangeError(`'byteLength' is out of range (0, ${e.byteLength - o}].`);
							if (typeof i == "object" && i) s = i;
					...
					a = new Uint8Array(e, o, c);
				}
			}
			let [c, l] = await o(s), u = await c.createInferenceSessionHandler(a, l);
			return A("InferenceSession.create"), O(), new e(u);
		}
		startProfiling() {
...
var Ae, je, Me, N = M(() => {
	fe(), he(), we(), xe(), Te(), Ee(), Se(), De(), Oe();
}), Ne = M(() => {}), Pe = {};
le(Pe, { default: () => Me });
var Fe, Ie, P, Le, F, Re, ze, Be, Ve, He, Ue, We, Ge, Ke, I, L, qe, Je, Ye, Xe, Ze, R, z, B, V, Qe, $e, et, tt, H, nt, rt, U, it, W, at, ot, st, ct, lt, ut, dt, ft, pt, G, mt, ht, gt, _t, vt, yt, bt, xt, St, K, q, J, Y, X, Ct, wt, Tt, Z, Q, Et, Dt, Ot, kt, At, jt, Mt, Nt, Pt, Ft, It, Lt, Rt, zt, Bt = M(() => {
	qt(), $(), Vt(), Ae = "ort-wasm-proxy-worker", (je = globalThis.self?.name === Ae) && (self.onmessage = (e) => {
		...
		try {
			switch (t) {
				...
				case "release":
					vt(n), postMessage({ type: t });
					break;
				case "run": {
					let { sessionId: e, inputIndices: r, inputs: i, outputIndices: a, options: o } = n;
					bt(e, r, i, a, Array(a.length).fill(null), o).then((e) => {
	...
	}), Me = je ? null : (e) => new Worker(e ?? P, {
		type: "module",
		name: Ae
	});
}), Vt = M(() => {
	Ne(), Fe = typeof location > "u" ? void 0 : location.origin, Ie = import.meta.url > "file:" && import.meta.url < "file;", P = Ie ? new URL(new URL("ort.wasm.min.mjs", "" + import.meta.url).href, Fe).href : import.meta.url, Le = () => {
		if (P && !P.startsWith("blob:")) return P.substring(0, P.lastIndexOf("/") + 1);
	}, F = (e, t) => {
		try {
			let n = t ?? P;
			return (n ? new URL(e, n) : new URL(e)).origin === Fe;
		} catch {
			return !1;
		}
	}, Re = (e, t) => {
	...
	}, ze = (e, t) => `${t ?? "./"}${e}`, Be = async (e) => {
		let t = await (await fetch(e, { credentials: "same-origin" })).blob();
		return URL.createObjectURL(t);
	}, Ve = async (e) => (await import(
		/*webpackIgnore:true*/
		e
)).default, He = (Bt(), ue(Pe)).default, Ue = async () => {
		if (!P) throw Error("Failed to load proxy worker: cannot determine the script source URL.");
		if (F(P)) return [void 0, He()];
		let e = await Be(P);
		return [e, He(e)];
	}, We = void 0, Ge = async (e, t, n, r) => {
		let i = We;
		if (i) {
			if (P) i = F(P) || r && !n;
			else {
				if (!r || n) throw Error("cannot determine the script source URL.");
				i = !0;
			}
		}
		if (i) return [void 0, We];
		{
			let r = "ort-wasm-simd-threaded.mjs", i = e ?? Re(r, t), a = n && i && !F(i, t), o = a ? await Be(i) : i ?? ze(r, t);
			return [a ? o : void 0, await Ve(o)];
		}
	};
}), $ = M(() => {
	Vt(), I = !1, L = !1, qe = !1, Je = () => {
		...
		if (L) throw Error("multiple calls to 'initializeWebAssembly()' detected.");
		if (qe) throw Error("previous call to 'initializeWebAssembly()' failed.");
		L = !0;
		let t = e.initTimeout, n = e.numThreads;
		if (!1 !== e.simd) {
			if (e.simd === "relaxed") {
				if (!Xe()) throw Error("Relaxed WebAssembly SIMD is not supported in the current environment.");
			} else if (!Ye()) throw Error("WebAssembly SIMD is not supported in the current environment.");
		}
		let r = Je();
		n > 1 && !r && (typeof self < "u" && self.crossOriginIsolated, e.numThreads = n = 1);
		let i = e.wasmPaths, a = typeof i == "string" ? i : void 0, o = i?.mjs, s = o?.href ?? o, c = i?.wasm, l = c?.href ?? c, u = e.wasmBinary, [d, f] = await Ge(s, a, n > 1, !!u || !!l), p = !1, m = [];
		if (t > 0 && m.push(new Promise((e) => {
			...
			f(r).then((t) => {
				L = !1, I = !0, Ke = t, e(), d && URL.revokeObjectURL(d);
			}, (e) => {
				L = !1, qe = !0, t(e);
			});
	...
	$(), z = (e, t) => {
		let n = R(), r = n.lengthBytesUTF8(e) + 1, i = n._malloc(r);
		...
		Object.entries(e).forEach(([e, i]) => {
			let a = t ? t + e : e;
			if (typeof i == "object") B(i, a + ".", n, r);
			else if (typeof i == "string" || typeof i == "number") r(a, i.toString());
			else {
				if (typeof i != "boolean") throw Error("Can't handle extra config type: " + typeof i);
				r(a, i ? "1" : "0");
			}
		});
	}, V = (e) => {
		let t = R(), n = t.stackSave();
		try {
	...
	$(), Ht(), Qe = (e) => {
		...
		try {
			...
			let a = 0;
			return e?.tag !== void 0 && (a = z(e.tag, r)), n = t._OrtCreateRunOptions(i.logSeverityLevel, i.logVerbosityLevel, !!i.terminate, a), n === 0 && V("Can't create run options."), e?.extra !== void 0 && B(e.extra, "", /* @__PURE__ */ new WeakSet(), (e, i) => {
				let a = z(e, r), o = z(i, r);
				t._OrtAddRunConfigEntry(n, a, o) !== 0 && V(`Can't set a run config entry: ${e} - ${i}.`);
			}), [n, r];
		} catch (e) {
	...
	$(), Ht(), $e = (e) => {
		...
		let i = z(t, r), a = z(n, r);
		R()._OrtAddSessionConfigEntry(e, i, a) !== 0 && V(`Can't set a session config entry: ${t} - ${n}.`);
	}, nt = async (e, t, n) => {
		...
		for (let t of r) {
			...
			switch (r) {
				case "webnn":
					if (r = "WEBNN", H(e, "session.disable_quant_qdq", "1", n), H(e, "session.disable_qdq_constant_folding", "1", n), typeof t != "string") {
						let r = t?.deviceType;
						r && H(e, "deviceType", r, n);
					}
					break;
				case "webgpu":
					if (r = "JS", typeof t != "string") {
						...
						if (r?.preferredLayout) {
							...
							H(e, "preferredLayout", r.preferredLayout, n);
						}
					}
					break;
				case "wasm":
			...
			let a = z(r, n), o = i.length, s = 0, c = 0;
			if (o > 0) {
				s = R()._malloc(o * R().PTR_SIZE), n.push(s), c = R()._malloc(o * R().PTR_SIZE), n.push(c);
				for (let e = 0; e < o; e++) R().setValue(s + e * R().PTR_SIZE, i[e][0], "*"), R().setValue(c + e * R().PTR_SIZE, i[e][1], "*");
			}
			await R()._OrtAppendExecutionProvider(e, a, s, c, o) !== 0 && V(`Can't append execution provider: ${r}.`);
		}
	}, rt = async (e) => {
		let t = R(), n = 0, r = [], i = e || {};
		tt(i);
		try {
			let e = $e(i.graphOptimizationLevel ?? "all"), a = et(i.executionMode ?? "sequential"), o = typeof i.logId == "string" ? z(i.logId, r) : 0, s = i.logSeverityLevel ?? 2;
			...
			let l = typeof i.optimizedModelFilePath == "string" ? z(i.optimizedModelFilePath, r) : 0;
			if (n = t._OrtCreateSessionOptions(e, !!i.enableCpuMemArena, !!i.enableMemPattern, a, !!i.enableProfiling, 0, o, s, c, l), n === 0 && V("Can't create session options."), i.executionProviders && await nt(n, i, r), i.enableGraphCapture !== void 0) {
				if (typeof i.enableGraphCapture != "boolean") throw Error(`enableGraphCapture must be a boolean value: ${i.enableGraphCapture}`);
				H(n, "enableGraphCapture", i.enableGraphCapture.toString(), r);
			}
			if (i.freeDimensionOverrides) for (let [e, a] of Object.entries(i.freeDimensionOverrides)) {
				...
				let i = z(e, r);
				t._OrtAddFreeDimensionOverride(n, i, a) !== 0 && V(`Can't set a free dimension override: ${e} - ${a}.`);
			}
			return i.extra !== void 0 && B(i.extra, "", /* @__PURE__ */ new WeakSet(), (e, t) => {
				H(n, e, t, r);
			}), [n, r];
		} catch (e) {
			throw n !== 0 && t._OrtReleaseSessionOptions(n) !== 0 && V("Can't release session options."), r.forEach((e) => t._free(e)), e;
		}
	};
}), Gt = M(() => {
	U = (e) => {
	...
	}, st = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", ct = (e) => e === "float32" || e === "float16" || e === "int32" || e === "int64" || e === "uint32" || e === "uint64" || e === "int8" || e === "uint8" || e === "bool" || e === "uint4" || e === "int4", lt = (e) => {
		switch (e) {
			case "none": return 0;
			case "cpu": return 1;
	...
	N(), Ut(), Wt(), Gt(), $(), Ht(), Kt(), dt = (e, t) => {
		R()._OrtInit(e, t) !== 0 && V("Can't initialize onnxruntime.");
	}, ft = async (e) => {
		dt(e.wasm.numThreads, ot(e.logLevel));
	}, pt = async (e, t) => {
		R().asyncInit?.();
	...
	}, G = /* @__PURE__ */ new Map(), mt = (e) => {
		let t = R(), n = t.stackSave();
		try {
			let n = t.PTR_SIZE, r = t.stackAlloc(2 * n);
			t._OrtGetInputOutputCount(e, r, r + n) !== 0 && V("Can't get session input/output count.");
			let i = n === 4 ? "i32" : "i64";
		...
		let n = R(), r = n.stackSave(), i = 0;
		try {
			let r = n.PTR_SIZE, a = n.stackAlloc(2 * r);
			n._OrtGetInputOutputMetadata(e, t, a, a + r) !== 0 && V("Can't get session input/output metadata.");
		...
		let t = R(), n = t._malloc(e.byteLength);
		...
		let a = 0, o = 0, s = [], c = [], l = [];
		try {
			if ([o, s] = await rt(t), t?.externalData && i.mountExternalData) {
				let e = [];
				for (let n of t.externalData) {
					let t = typeof n == "string" ? n : n.path;
					e.push(ut(typeof n == "string" ? n : n.data).then((e) => {
			...
			a = await i._OrtCreateSession(n, r, o), i.webgpuOnCreateSession?.(a), a === 0 && V("Can't create a session."), i.jsepOnCreateSession?.(), i.currentContext && (i.webnnRegisterMLContext(a, i.currentContext), i.currentContext = void 0, i.shouldTransferToMLTensor = !0);
			let [e, u] = mt(a), d = !!t?.enableGraphCapture, f = [], p = [], m = [], h = [];
			for (let t = 0; t < e; t++) {
				let [e, n, r] = ht(a, t);
				e === 0 && V("Can't get an input name."), c.push(e);
			...
			for (let t = 0; t < u; t++) {
				let [n, r, o] = ht(a, t + e);
				n === 0 && V("Can't get an output name."), l.push(n);
			...
			throw c.forEach((e) => i._OrtFree(e)), l.forEach((e) => i._OrtFree(e)), a !== 0 && i._OrtReleaseSession(a) !== 0 && V("Can't release session."), e;
		} finally {
			i._free(n), o !== 0 && i._OrtReleaseSessionOptions(o) !== 0 && V("Can't release session options."), s.forEach((e) => i._free(e)), i.unmountExternalData?.();
		}
	}, vt = (e) => {
		let t = R(), n = G.get(e);
		if (!n) throw Error(`cannot release session. invalid session id: ${e}`);
		let [r, i, a, o, s] = n;
		o && (s && t._OrtClearBoundOutputs(o.handle) !== 0 && V("Can't clear bound outputs."), t._OrtReleaseBinding(o.handle) !== 0 && V("Can't release IO binding.")), t.jsepOnReleaseSession?.(e), t.webnnOnReleaseSession?.(e), t.webgpuOnReleaseSession?.(e), i.forEach((e) => t._OrtFree(e)), a.forEach((e) => t._OrtFree(e)), t._OrtReleaseSession(r) !== 0 && V("Can't release session."), G.delete(e);
	}, yt = async (e, t, n, r, i, a, o = !1) => {
		if (!e) return void t.push(0);
		let s, c, l = R(), u = l.PTR_SIZE, d = e[0], f = e[1], p = e[3], m = p;
		if (d === "string" && (p === "gpu-buffer" || p === "ml-tensor")) throw Error("String tensor is not supported on GPU.");
		if (o && p !== "gpu-buffer") throw Error(`External buffer must be provided for input/output index ${a} when enableGraphCapture is true.`);
		if (p === "gpu-buffer") {
			let t = e[2].gpuBuffer;
			c = W(U(d), f);
			{
			...
			let t = e[2];
			if (Array.isArray(t)) {
				c = u * t.length, s = l._malloc(c), n.push(s);
				for (let e = 0; e < t.length; e++) {
					if (typeof t[e] != "string") throw TypeError(`tensor data at index ${e} is not a string`);
					l.setValue(s + e * u, z(t[e], n), "*");
				}
			} else {
				let e = l.webnnIsGraphInput, a = l.webnnIsGraphOutput;
				if (d !== "string" && e && a) {
					let o = l.UTF8ToString(i);
					if (e(r, o) || a(r, o)) {
						let e = U(d);
						c = W(e, f), m = "ml-tensor";
						let n = l.webnnCreateTemporaryTensor, i = l.webnnUploadTensor;
						if (!n || !i) throw Error("Tensor location \"ml-tensor\" is not supported without using WebNN.");
						let a = await n(r, e, f);
						i(a, new Uint8Array(t.buffer, t.byteOffset, t.byteLength)), s = a;
					} else c = t.byteLength, s = l._malloc(c), n.push(s), l.HEAPU8.set(new Uint8Array(t.buffer, t.byteOffset, c), s);
				} else c = t.byteLength, s = l._malloc(c), n.push(s), l.HEAPU8.set(new Uint8Array(t.buffer, t.byteOffset, c), s);
			}
		}
		let h = l.stackSave(), g = l.stackAlloc(4 * f.length);
		try {
			f.forEach((e, t) => l.setValue(g + t * u, e, u === 4 ? "i32" : "i64"));
			let e = l._OrtCreateTensor(U(d), s, c, g, f.length, lt(m));
			e === 0 && V(`Can't create tensor for input/output. session=${r}, index=${a}.`), t.push(e);
		} finally {
			l.stackRestore(h);
		}
	}, bt = async (e, t, n, r, i, a) => {
		let o = R(), s = o.PTR_SIZE, c = G.get(e);
		if (!c) throw Error(`cannot run inference. invalid session id: ${e}`);
		let l = c[0], u = c[1], d = c[2], f = c[3], p = c[4];
		c[5];
		let m = t.length, h = r.length, g = 0, _ = [], v = [], y = [], b = [], x = [], S = o.stackSave(), C = o.stackAlloc(m * s), ee = o.stackAlloc(m * s), w = o.stackAlloc(h * s), T = o.stackAlloc(h * s);
		try {
			[g, _] = Qe(a), k("wasm prepareInputOutputTensor");
			for (let r = 0; r < m; r++) await yt(n[r], v, b, e, u[t[r]], t[r], p);
			for (let t = 0; t < h; t++) await yt(i[t], y, b, e, d[r[t]], m + r[t], p);
			A("wasm prepareInputOutputTensor");
			for (let e = 0; e < m; e++) o.setValue(C + e * s, v[e], "*"), o.setValue(ee + e * s, u[t[e]], "*");
			for (let e = 0; e < h; e++) o.setValue(w + e * s, y[e], "*"), o.setValue(T + e * s, d[r[e]], "*");
			let c;
			o.jsepOnRunStart?.(l), o.webnnOnRunStart?.(l), c = await o._OrtRun(l, ee, C, m, T, h, w, g), c !== 0 && V("failed to call OrtRun().");
			let S = [], E = [];
			k("wasm ProcessOutputTensor");
			for (let t = 0; t < h; t++) {
				let n = Number(o.getValue(w + t * s, "*"));
				if (n === y[t] || x.includes(y[t])) {
					S.push(i[t]), n !== y[t] && o._OrtReleaseTensor(n) !== 0 && V("Can't release tensor.");
					continue;
				}
				let a, c = o.stackSave(), l = o.stackAlloc(4 * s), u = !1, d = 0;
				try {
					o._OrtGetTensorData(n, l, l + s, l + 2 * s, l + 3 * s) !== 0 && V(`Can't access output tensor data on index ${t}.`);
					let i = s === 4 ? "i32" : "i64", c = Number(o.getValue(l, i));
					d = o.getValue(l + s, "*");
					let p = o.getValue(l + 2 * s, "*"), m = Number(o.getValue(l + 3 * s, i)), h = [];
					for (let e = 0; e < m; e++) h.push(Number(o.getValue(p + e * s, i)));
					o._OrtFree(p) !== 0 && V("Can't free memory for tensor dims.");
					...
					if (a === "string") {
						...
						let t = e(d), r = W(c, g);
						if (r === void 0 || !st(a)) throw Error(`Unsupported data type: ${a}`);
						u = !0, S.push([
							a,
							h,
							{
								gpuBuffer: t,
								download: o.jsepCreateDownloader(t, r, a),
								dispose: () => {
									o._OrtReleaseTensor(n) !== 0 && V("Can't release tensor.");
								}
							},
							"gpu-buffer"
						]);
						...
						if (W(c, g) === void 0 || !ct(a)) throw Error(`Unsupported data type: ${a}`);
						if (!r(e, a, !1)) throw Error(`preferredLocation "ml-tensor" for ${a} output is not supported by current WebNN Context.`);
						let i = await t(e, d, c, h, !1);
						u = !0, S.push([
							a,
							h,
							{
						...
						let e = o.webnnCreateMLTensorDownloader(d, a)(), t = S.length;
						u = !0, E.push((async () => {
							let r = [t, await e];
					...
					o.stackRestore(c), a === "string" && d && o._free(d), u || o._OrtReleaseTensor(n);
				}
			}
			f && !p && (o._OrtClearBoundOutputs(f.handle) !== 0 && V("Can't clear bound outputs."), G.set(e, [
				l,
				u,
				d,
				f,
			...
			for (let [e, t] of await Promise.all(E)) S[e][2] = t;
			return A("wasm ProcessOutputTensor"), S;
		} finally {
	...
	N(), qt(), $(), Vt(), K = () => !!u.wasm.proxy && typeof document < "u", J = !1, Y = !1, X = !1, Tt = /* @__PURE__ */ new Map(), Z = (e, t) => {
		let n = Tt.get(e);
		n ? n.push(t) : Tt.set(e, [t]);
	}, Q = () => {
		if (J || !Y || X || !q) throw Error("worker not ready");
	}, Et = (e) => {
		switch (e.data.type) {
			case "init-wasm":
				J = !1, e.data.err ? (X = !0, wt[1](e.data.err)) : (Y = !0, wt[0]()), Ct &&= (URL.revokeObjectURL(Ct), void 0);
				break;
			case "init-ep":
			case "copy-from":
			case "create":
		...
		if (!Y) {
			if (J) throw Error("multiple calls to 'initWasm()' detected.");
			if (X) throw Error("previous call to 'initWasm()' failed.");
			if (J = !0, K()) return new Promise((e, t) => {
				q?.terminate(), Ue().then(([n, r]) => {
					try {
						(q = r).onerror = (e) => t(e), q.onmessage = Et, wt = [e, t];
						let i = {
							type: "init-wasm",
							in: u
						};
			...
			try {
				await Ze(u.wasm), await ft(u), Y = !0;
			} catch (e) {
				throw X = !0, e;
			} finally {
				J = !1;
		...
		if (K()) {
			...
			return Q(), new Promise((n, r) => {
				...
				e instanceof Uint8Array && a.push(e.buffer), q.postMessage(i, a);
			});
		}
		return _t(e, t);
	}, jt = async (e) => {
		...
		if (K()) {
			...
			return Q(), new Promise((i, o) => {
				...
				q.postMessage(c, St(s));
			});
		}
		return bt(e, t, n, r, i, a);
	}, Nt = async (e) => {
		if (K()) return Q(), new Promise((t, n) => {
			Z("end-profiling", [t, n]);
			let r = {
	...
	N(), Jt(), Gt(), Ne(), Kt(), Pt = (e, t) => {
		...
		switch (e[3]) {
			case "cpu": return new T(e[0], e[2], e[1]);
			case "gpu-buffer": {
				let t = e[0];
				if (!st(t)) throw Error(`not supported data type: ${t} for deserializing GPU tensor`);
				let { gpuBuffer: n, download: r, dispose: i } = e[2];
				return T.fromGpuBuffer(n, {
					dataType: t,
					dims: e[1],
					download: r,
					dispose: i
			...
			case "ml-tensor": {
				let t = e[0];
				if (!ct(t)) throw Error(`not supported data type: ${t} for deserializing MLTensor tensor`);
				let { mlTensor: n, download: r, dispose: i } = e[2];
				return T.fromMLTensor(n, {
					dataType: t,
					dims: e[1],
					download: r,
					dispose: i
		...
		async fetchModelAndCopyToWasmMemory(e) {
			return kt(await ut(e));
		}
		async loadModel(e, t) {
			let n;
			D(), n = typeof e == "string" ? await this.fetchModelAndCopyToWasmMemory(e) : e, [this.sessionId, this.inputNames, this.outputNames, this.inputMetadata, this.outputMetadata] = await At(n, t), O();
		}
		async dispose() {
			return jt(this.sessionId);
		}
		async run(e, t, n) {
			D();
			let r = [], i = [];
			...
			let s = r.map((e, t) => Pt(e, () => `input "${this.inputNames[i[t]]}"`)), c = a.map((e, t) => e ? Pt(e, () => `output "${this.outputNames[o[t]]}"`) : null), l = await Mt(this.sessionId, i, s, o, c, n), u = {};
			for (let e = 0; e < l.length; e++) u[this.outputNames[o[e]]] = a[e] ?? Ft(l[e]);
			return O(), u;
		}
		startProfiling() {}
		endProfiling() {
...
le(Xt, {
	OnnxruntimeWebAssemblyBackend: () => Rt,
	initializeFlags: () => Lt,
	wasmBackend: () => zt
});
var Zt = M(() => {
	N(), Jt(), Yt(), Lt = () => {
		(typeof u.wasm.initTimeout != "number" || u.wasm.initTimeout < 0) && (u.wasm.initTimeout = 0);
		let e = u.wasm.simd;
		if (typeof e != "boolean" && e !== void 0 && e !== "fixed" && e !== "relaxed" && (u.wasm.simd = !1), typeof u.wasm.proxy != "boolean" && (u.wasm.proxy = !1), typeof u.wasm.trace != "boolean" && (u.wasm.trace = !1), typeof u.wasm.numThreads != "number" || !Number.isInteger(u.wasm.numThreads) || u.wasm.numThreads <= 0) {
			if (typeof self < "u" && !self.crossOriginIsolated) u.wasm.numThreads = 1;
			else {
				let e = typeof navigator > "u" ? ce("node:os").cpus().length : navigator.hardwareConcurrency;
				u.wasm.numThreads = Math.min(4, Math.ceil((e || 1) / 2));
			}
		}
	}, zt = new (Rt = class {
		async init(e) {
			Lt(), await Dt(), await Ot(e);
		}
...
var Qt = ke;
{
	let e = (Zt(), ue(Xt)).wasmBackend;
	i("cpu", e, 10), i("wasm", e, 10);
}
Object.defineProperty(u.versions, "web", {
	value: "1.27.0",
	enumerable: !0
});
//#endregion
export { re as InferenceSession, E as TRACE, k as TRACE_EVENT_BEGIN, A as TRACE_EVENT_END, D as TRACE_FUNC_BEGIN, O as TRACE_FUNC_END, T as Tensor, Qt as default, u as env, i as registerBackend };
