"""Compact agent pipeline cho thủ tục 1.115671 (Lào Cai)."""

from app.pipelines._shared.compact_agent import runner
from app.pipelines.dang_ky_bien_dong_lao_cai.process import mapper
from app.pipelines.dang_ky_bien_dong_lao_cai.process.prompt import EXTRA_RULES
from app.pipelines.dang_ky_bien_dong_lao_cai.process.schema import (
    ALIASES,
    ALLOWED,
