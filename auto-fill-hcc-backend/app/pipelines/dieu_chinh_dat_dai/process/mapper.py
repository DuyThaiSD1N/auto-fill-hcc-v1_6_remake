"""Map compact source facts to standard DOM UI fields for land adjustment."""

import re

from app.pipelines.dieu_chinh_dat_dai.process.schema import UI_ALIASES, UI_COMP_BY_NAME
