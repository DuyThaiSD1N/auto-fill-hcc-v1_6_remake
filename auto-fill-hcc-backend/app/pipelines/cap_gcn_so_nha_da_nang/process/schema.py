"""Compact schema cho "Cấp mới/cấp lại Giấy chứng nhận số nhà" — cổng DVC TP Đà Nẵng
dichvucong.danang.gov.vn (Form.io). CÙNG cổng/engine với #75 (dang_ky_bien_dong_dat_dai_da_nang) và
#95 (dang_ky_bien_phap_bao_dam_qsdd) — field-key data[...] y hệt.
