"""Map compact source facts → Form.io data[...] fields cho "Cấp mới/cấp lại GCN số nhà" (cổng Đà Nẵng).
...
from app.pipelines.cap_gcn_so_nha_da_nang.process.schema import UI_COMP_BY_NAME

# "Nội dung yêu cầu giải quyết" ghép: "{tên chủ hồ sơ} ĐỀ NGHỊ GIẢI QUYẾT {tên thủ tục}[ tại địa chỉ …]".
_PROC_TITLE = "Cấp mới/cấp lại Giấy chứng nhận số nhà"
