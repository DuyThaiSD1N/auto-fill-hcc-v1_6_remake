...
from app.pipelines.dang_ky_dat_dai_lan_dau_lam_dong.process.schema import UI_COMP_BY_NAME
...
def enrich(fields: list[dict], options: dict | None = None) -> tuple[list[dict], list[str]]:
    ...
    # Ô "Ghi chú" (data[ghiChu]) = tự nhập → để trống.
    ...
    # ---- Phần III: Thông tin chủ hồ sơ (chủ hộ đứng đơn) ----
    ...
    # Phần IV "Thông tin chi tiết" (GCN) = KHÔNG cần điền với đăng ký lần đầu (chưa có GCN) → bỏ.
