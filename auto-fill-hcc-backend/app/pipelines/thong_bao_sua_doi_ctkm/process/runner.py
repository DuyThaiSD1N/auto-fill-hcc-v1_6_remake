"""Compact agent process pipeline cho "Thông báo sửa đổi, bổ sung nội dung chương trình khuyến mại"
...
from app.pipelines.thong_bao_sua_doi_ctkm.process.schema import (
    ALIASES,
    ALLOWED,
