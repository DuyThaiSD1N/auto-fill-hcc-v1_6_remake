"""Map compact source facts → Form.io data[...] cho [Lâm Đồng] chuyển mục đích/chuyển hình thức/gia
hạn/điều chỉnh thời hạn sử dụng đất (1.116365).
...
def _ghi_chu(values: dict, owner_name: str | None, has_uy_quyen: bool) -> str | None:
    """Ô "Ghi Chú:" — nội dung đề nghị + định vị thửa đất; có ủy quyền thì ghi rõ đang nộp thay.
    Mọi vế đều suy TẤT ĐỊNH từ fact đã đọc được, không thêm chi tiết nào không có trong hồ sơ."""
    parts: list[str] = []
