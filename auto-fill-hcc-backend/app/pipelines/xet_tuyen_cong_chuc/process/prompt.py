"""Procedure-specific compact prompt rules for "Xét tuyển công chức"."""

EXTRA_RULES = """<critical_rules>
1. Phiếu đăng ký dự tuyển theo Mẫu số 01 là nguồn chính cho toàn bộ Phieu_*.
...
1. Nhận diện Phiếu đăng ký dự tuyển công chức theo các cụm: "PHIẾU ĐĂNG KÝ DỰ TUYỂN",
   "Mẫu số 01", "Nghị định số 170/2025/NĐ-CP", "xét tuyển công chức", hoặc nội dung
