"""Quy tắc compact prompt cho "[Bắc Ninh] Cấp đổi Giấy chứng nhận QSDĐ"."""
...
- Don_NoiDungBienDong CHỈ lấy từ mục 2 "Nội dung biến động" của Đơn Mẫu số 18, NGUYÊN VĂN — với thủ
  tục cấp đổi thường là "Cấp đổi giấy chứng nhận quyền sử dụng đất". Nếu mục này trống thì BỎ field.
...
```json
{"fields":{"Cccd_HoTen":"Lù Thị Diễm","Cccd_SoDinhDanh":"012190000192","Cccd_NgayCap":"03/06/2022","Cccd_NoiCap":"Cục Cảnh sát quản lý hành chính về trật tự xã hội","Don_KinhGui":"Chi nhánh Văn phòng đăng ký đất đai","Don_DiaChi":"Bản Nậm Dòn, xã Nậm Hàng, tỉnh Lai Châu","Don_DienThoai":"0396095455","Don_NoiDungBienDong":"Cấp đổi giấy chứng nhận quyền sử dụng đất"}}
```"""
