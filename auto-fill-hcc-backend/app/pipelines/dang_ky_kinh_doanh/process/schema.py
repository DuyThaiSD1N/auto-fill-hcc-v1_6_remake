...
FIELDS: list[dict] = [
    ...
    {"name": "NguoiNop_SoDinhDanh", "desc": "Số định danh cá nhân/CCCD của người nộp hồ sơ."},
    {
        ...
        "desc": (
            "Địa chỉ người nộp hồ sơ, object {quocGia,tinh,xa,diaChi}; nếu người nộp là chủ hộ thì dùng địa chỉ "
            "cá nhân của chủ hộ trên Giấy đề nghị, nếu người nộp khác chủ hộ thì lấy theo giấy ủy quyền."
        ),
    },
]
