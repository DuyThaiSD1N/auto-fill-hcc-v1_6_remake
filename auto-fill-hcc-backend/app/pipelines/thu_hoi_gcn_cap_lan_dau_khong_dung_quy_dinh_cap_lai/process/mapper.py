...
def enrich(fields: list[dict], options: dict | None = None) -> list[dict]:
    ...
    # Ba ô địa chỉ của khối người nộp là BẮT BUỘC và cổng để TRỐNG ở thủ tục này → phải điền, và điền bằng nơi
    # thường trú của CHÍNH người đi nộp (không phải của chủ hồ sơ).
    applicant_area = (
