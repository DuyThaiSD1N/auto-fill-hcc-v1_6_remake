"""Schema hai vai trò cho thủ tục hỗ trợ chi phí mai táng.
...
FIELDS: list[dict] = [
    ...
    },
    {
        ...
        "desc": "Ngày cấp giấy tờ định danh của chủ hồ sơ, dd/mm/yyyy, lấy từ mục II.2 hoặc CCCD đúng người khi OCR ghi rõ.",
    },
    {
        "name": "ChuHoSo_NoiCap",
        "desc": "Nơi cấp giấy tờ định danh của chủ hồ sơ từ mục II.2 hoặc CCCD đúng người; không lấy chữ trên logo/dấu.",
    },
    {
        "name": "ChuHoSo_NoiCuTru",
        "desc": "Hộ khẩu thường trú/Nơi ở của chủ hồ sơ tại mục II.2, object {quocGia,tinh,xa,diaChi}. Ưu tiên tờ khai; CCCD chỉ bổ sung khi cả hai dòng địa chỉ mục II.2 trống.",
    },
    {
    ...
    },
    {
        ...
        "desc": "Ngày sinh người nộp, dd/mm/yyyy, lấy từ đúng CCCD/CMND hoặc khối người nộp đã được requester_context xác nhận.",
    },
    {
        "name": "NguoiNop_GioiTinh",
        "desc": 'Giới tính người nộp, chỉ "Nam" hoặc "Nữ" khi tài liệu ghi rõ; không suy từ tên.',
    },
    {
