"""Prompt rules đặc thù cho "Xác nhận hồ sơ cấp mới/cấp lại GCN biển số nhà" (cổng DVC Đà Nẵng — Form.io)."""

EXTRA_RULES = """Thủ tục: Xác nhận hồ sơ cấp mới/cấp lại Giấy chứng nhận (biển) số nhà — cổng DVC TP Đà Nẵng.
