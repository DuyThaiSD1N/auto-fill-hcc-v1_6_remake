"""Compact agent pipeline cho thủ tục 1.115651 (Lào Cai)."""

from app.pipelines._shared.compact_agent import runner
from app.pipelines.chuyen_doi_md_sd_dat_lao_cai.process import mapper
from app.pipelines.chuyen_doi_md_sd_dat_lao_cai.process.prompt import EXTRA_RULES
from app.pipelines.chuyen_doi_md_sd_dat_lao_cai.process.schema import (
    ALIASES,
    ALLOWED,
