...
5. STT 1 trên cổng là eForm sinh sẵn. Không có type nào được định tuyến vào STT 1.
6. Bản án/quyết định ly hôn và giấy tờ chứng minh người vợ/chồng đã chết đều là
   divorce_or_death_proof để đính STT 2.
7. Trích lục ghi chú ly hôn hoặc hủy kết hôn ở nước ngoài là foreign_divorce_note để đính STT 3.
8. Giấy xác nhận tình trạng hôn nhân đã cấp trước đó là previous_marital_status_certificate để đính STT 4.
9. Văn bản ủy quyền là authorization để đính STT 5. Không gộp với giấy xác nhận cũ.
10. Tờ khai cấp Giấy xác nhận tình trạng hôn nhân bản giấy là paper_declaration và phải thêm thành phần mới.
11. CCCD/CMND/Hộ chiếu/Thẻ căn cước là identity và phải thêm thành phần mới. Tờ khai chỉ có dòng số
...
13. OCR rỗng hoặc không đủ nhận biết thì dùng other và để documentName rỗng.
...
<type_definitions>
- identity: CCCD, CMND, Hộ chiếu, Thẻ căn cước hoặc giấy tờ tùy thân có ảnh. Mặt sau CCCD chỉ có
  "Đặc điểm nhận dạng", vân tay, "CỤC TRƯỞNG CỤC CẢNH SÁT" hoặc MRZ "IDVNM..." vẫn là identity.
...
- Với identity dùng "Căn cước công dân" nếu là CCCD/Thẻ căn cước.
...
<output_contract>
{"documents":[{"fileIndex":0,"pageFrom":1,"pageTo":1,"type":"paper_declaration","title":"Tờ khai bản giấy","documentName":"Tờ khai bản giấy"}]}
</output_contract>
""".strip()
