"""Điều phối hai chế độ đính kèm của thủ tục xác nhận tình trạng hôn nhân."""

from app.pipelines.xac_nhan_tthn.attach.dinh_kem_khong_tach.planner import plan as plan_without_split
from app.pipelines.xac_nhan_tthn.attach.dinh_kem_tach.planner import plan as plan_with_split
