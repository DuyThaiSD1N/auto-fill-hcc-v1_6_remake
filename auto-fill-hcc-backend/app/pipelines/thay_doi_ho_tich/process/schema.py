...
FIELDS: list[dict] = [
    ...
    # Chỉ nhóm CCCD người yêu cầu; CCCD người khác được hợp nhất vào ChuThe/Chong/Vo.
...
for _name in ("ChuThe_NoiCuTru", "Chong_NoiCuTru", "Vo_NoiCuTru"):
    COMPACT_COMP_BY_NAME[_name] = "x-select-area"

# Field UI thật trên form (tên = thuộc tính name của web-component x-* đã render).
UI_COMP_BY_NAME = {
    # Mục I — người yêu cầu (cổng tự điền danh tính; ta chỉ thêm "Số" giấy tờ + default cư trú).
    "SoGiayToTuyThanC": "x-input",  # (3) Số = số định danh cá nhân cổng đã điền sẵn
