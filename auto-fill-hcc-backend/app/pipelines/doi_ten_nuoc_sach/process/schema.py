"""Compact schema for "Thủ tục chuyển đổi tên trong HĐ dịch vụ sử dụng nước sạch"."""
...
FIELDS: list[dict] = [
    ...
    {
        "name": "Cccd_NoiCap",
        "desc": 'Nơi cấp CCCD/CMND từ mặt sau. Với thẻ căn cước mới nếu ghi "Bộ Công an" thì trả "Bộ Công an".',
    },
    {
        "name": "Cccd_QueQuan",
        "desc": "Quê quán/place of origin nếu có, object {tinh, xa, diaChi}.",
    },
    {
        "name": "Cccd_NoiCuTru",
        "desc": "Nơi cư trú/place of residence, object {tinh, xa, diaChi, fullText}; dùng khi không có quê quán.",
    },

    # Đơn xin đổi tên trong hợp đồng dịch vụ cấp nước.
    {"name": "DonDoiTen_SoDienThoai", "desc": "Số điện thoại/điện thoại liên hệ trong đơn đổi tên; số di động VN 10 số."},
    {"name": "DonDoiTen_DiaChiThuongTru", "desc": "Địa chỉ thường trú trong đơn đổi tên nếu có."},
    {"name": "DonDoiTen_DiaChiHopDong", "desc": "Địa chỉ hợp đồng/địa chỉ sử dụng nước trong đơn đổi tên nếu có."},
    {"name": "DonDoiTen_MaKhachHang", "desc": "Mã khách hàng nếu đọc được trong đơn đổi tên."},
    {"name": "DonDoiTen_NguoiDungTenCu", "desc": "Người đứng tên trong hợp đồng sử dụng nước cũ nếu đọc được."},
    {"name": "DonDoiTen_LyDo", "desc": "Lý do đổi tên nếu đọc được."},
    {"name": "DonDoiTen_TenCoQuanToChuc", "desc": "Tên doanh nghiệp/cơ quan/tổ chức đứng tên hồ sơ nếu có."},
    {"name": "DonDoiTen_MaSoThue", "desc": "Mã số thuế/MSDN của doanh nghiệp/cơ quan/tổ chức nếu có."},

    # Giấy chứng nhận quyền sử dụng đất/quyền sở hữu tài sản gắn liền với đất.
    {"name": "Gcn_SoPhatHanh", "desc": "Số phát hành GCN trên bìa, thường 2 chữ cái + 6-8 số."},
    {"name": "Gcn_SoVaoSo", "desc": 'Số vào sổ cấp GCN nếu có; ví dụ "VP.140". Không dùng field này làm Số GCN/GP.'},
...
for _name in ("Cccd_QueQuan", "Cccd_NoiCuTru"):
