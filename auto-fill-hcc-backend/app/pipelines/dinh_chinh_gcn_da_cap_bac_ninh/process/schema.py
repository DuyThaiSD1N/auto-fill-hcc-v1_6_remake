"""Compact schema cho "[Bắc Ninh] Đính chính giấy chứng nhận đã cấp" (maThuTuc 1.012790).
...
NHÃN (title đã fold); ô người nhận khớp theo NAME.
"""
...
FIELDS: list[dict] = [
    ...
    {"name": "Don_NoiDungBienDong",
     "desc": 'Nội dung biến động ghi ở mục 2 của Đơn Mẫu số 18, NGUYÊN VĂN — với thủ tục này thường là '
             'đính chính thông tin trên Giấy chứng nhận đã cấp (vd "Đính chính diện tích/số tờ, số thửa/'
             'họ tên..."). Chép đúng như trong đơn, không tự bịa.'},
    {"name": "Don_GiayTo2",
