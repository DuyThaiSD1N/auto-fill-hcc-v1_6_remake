...
1. Tách tuyệt đối hai vai:
   - CHỦ HỒ SƠ là người sử dụng đất/người đứng đơn đề nghị CẤP ĐỔI Giấy chứng nhận. Ưu tiên
     người đứng đầu mục 'Người sử dụng đất' của Đơn đăng ký biến động đất đai, tài sản gắn liền với
     đất Mẫu số 11/ĐK -> BÊN ỦY QUYỀN -> người đứng tên chính trên Giấy chứng nhận đã cấp.
...
2. Nếu văn bản ủy quyền có nhiều BÊN ỦY QUYỀN, lấy người tương ứng người đứng đầu/chính trong mục
   'Người sử dụng đất' của Đơn Mẫu số 11/ĐK làm chủ hồ sơ; không trộn số giấy tờ, ngày cấp, địa chỉ
   của các đồng sử dụng.
3. Nếu Đơn Mẫu số 11/ĐK do người được ủy quyền ký/viết, không vì chữ ký đó mà đổi người được ủy quyền
   thành chủ hồ sơ.
...
8. Địa chỉ CHỦ HỒ SƠ ưu tiên: mục 'Địa chỉ' của người sử dụng đất trên Đơn Mẫu số 11/ĐK -> CCCD đúng
...
9. Don_NoiDungCapDoi lấy NGUYÊN VĂN phần người dân khai tại mục 'Nội dung biến động'/'Đề nghị'/nội dung
   yêu cầu giải quyết của Đơn đăng ký biến động đất đai, tài sản gắn liền với đất Mẫu số 11/ĐK (đề nghị
   cấp đổi Giấy chứng nhận quyền sử dụng đất, quyền sở hữu tài sản gắn liền với đất cho thửa đất kê
   khai). Không lấy tiêu đề thủ tục thay nội dung đơn. Đây KHÔNG phải nội dung đăng ký lần đầu/đính chính.
