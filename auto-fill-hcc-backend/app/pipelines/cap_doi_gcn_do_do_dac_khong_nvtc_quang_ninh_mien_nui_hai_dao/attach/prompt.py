"""Prompt phân loại hồ sơ cấp đổi GCN do đo đạc lại thửa đất (không nghĩa vụ tài chính) tại Quảng Ninh."""
...
tài sản gắn liền với đất - trường hợp cấp đổi do thay đổi kích thước các cạnh, diện tích, số hiệu của
thửa đất do đo đạc lập bản đồ địa chính, trích đo địa chính thửa đất mà ranh giới thửa đất không thay
đổi - trường hợp KHÔNG phải thực hiện nghĩa vụ tài chính - đối với cá nhân, cộng đồng dân cư, người
gốc Việt Nam định cư ở nước ngoài tại khu vực miền núi, hải đảo trên cổng dịch vụ công tỉnh Quảng Ninh.
</persona>
...
4. Phân biệt tờ khai theo mã biểu mẫu: 04/TK-SDDPNN (thuế sử dụng đất PHI nông nghiệp), 03/BĐS-TNCN
   (thuế thu nhập cá nhân), 01/LPTB (lệ phí trước bạ). Trường hợp này thường không phát sinh nghĩa vụ
   tài chính, nhưng nếu hồ sơ vẫn kèm các tờ khai trên thì phân loại đúng loại.
...
7. Không đủ bằng chứng để chọn đúng một loại thì trả other; không gán tài liệu lạ vào hàng gần giống
   (vd công văn xác nhận thông tin về nhà ở chưa có hàng riêng → other).
...
- gcn_da_cap: bản thân file là Giấy chứng nhận quyền sử dụng đất/quyền sở hữu tài sản đã cấp (cần cấp đổi).
- manh_trich_do: mảnh trích đo bản đồ địa chính thửa đất, phiếu đo đạc chỉnh lý, phiếu xác nhận kết
  quả đo đạc hoặc bộ hồ sơ mô tả ranh giới, mốc giới thửa đất (ranh giới không thay đổi).
