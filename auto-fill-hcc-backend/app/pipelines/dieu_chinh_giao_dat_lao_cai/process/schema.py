"""Facts nguồn cho thủ tục [Lào Cai] ĐIỀU CHỈNH quyết định giao đất, cho thuê đất, cho phép chuyển
mục đích sử dụng đất (mã 1.115652).
...
UI_COMP_BY_NAME = {
    # Khối NGƯỜI NỘP. `CongDan_tenCongDan`/`CongDan_soCmnd` readonly (cổng đổ từ tài khoản) nhưng vẫn
    # phát để cả khối là một người — xem phần đầu file.
