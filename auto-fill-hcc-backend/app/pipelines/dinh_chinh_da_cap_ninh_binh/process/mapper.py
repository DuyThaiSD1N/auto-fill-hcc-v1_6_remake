"""Map facts nguồn sang Form.io của cổng DVC Ninh Bình (đính chính Giấy chứng nhận đã cấp, Mẫu số 11/ĐK)."""
...
def enrich(fields: list[dict], options: dict | None = None) -> tuple[list[dict], list[str]]:
    ...
    # Ô Ghi chú: nêu rõ CCCD được đính chung dòng Đơn Mẫu 11 (form đính chính này có dòng riêng cho
    # Bản gốc GCN / giấy tờ chứng minh sai sót / văn bản ủy quyền, nhưng KHÔNG có dòng CCCD riêng).
    add(
        "data[note]",
        "Căn cước công dân/CMND của người nộp được đính kèm chung tại dòng Đơn đăng ký biến động đất "
        "đai (Mẫu số 11/ĐK).",
        default=True,
    )
