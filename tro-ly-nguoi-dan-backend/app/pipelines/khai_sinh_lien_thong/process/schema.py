...
UI_COMP_BY_NAME = {
    ...
    "GiayCNKHNoiCap": "text",
    # Đăng ký thường trú — các control của form Angular liên thông.
    ...
    "DkttMaQuanHe": "select",
    "LoaiThanNhanXacNhan": "radio",
    "LoaiChuSoHuuChoO": "radio",
    # Người yêu cầu.
    "NycSdt": "text",
...
STATIC_DEFAULTS: list[dict] = [
    ...
    # Khi không có CT01 để xác định chủ hộ, form liên thông cần một cấu hình hoàn chỉnh để
    # extension có thể điền xuyên suốt: xác nhận qua VNeID, bố là chủ hộ/người xác nhận/chủ sở hữu.
    # Nếu CT01 có dữ liệu, mapper sẽ phát hiện và chặn các default này khi chúng có thể ghi đè
    ...
    {"name": "DkttIsTtMe", "comp": "checkbox", "value": False, "default": True},
    {"name": "LoaiThanNhanXacNhan", "comp": "radio", "value": "1", "default": True},
    {"name": "LoaiChuSoHuuChoO", "comp": "radio", "value": "1", "default": True},
