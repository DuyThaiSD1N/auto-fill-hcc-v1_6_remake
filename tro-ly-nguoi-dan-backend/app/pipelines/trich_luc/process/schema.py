...
FIELDS: list[dict] = [
    ...
    # (5) Quan hệ NGƯỜI YÊU CẦU ↔ người được cấp — tro-ly tự tick radio này từ tờ khai.
...
UI_COMP_BY_NAME = {
    ...
    # (5) Quan hệ với người được cấp bản sao — radio, mapper khớp NHÃN option từ tờ khai.
    "NYC_QuanHe": "x-radio",
