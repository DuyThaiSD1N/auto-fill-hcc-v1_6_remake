...
- Marriage_SpouseName = họ tên người vợ/chồng hiện tại — NGƯỜI CÒN LẠI, khác người yêu cầu (giấy kết hôn
  có 2 người: đối chiếu tên trên CCCD người yêu cầu → lấy tên người KHÔNG trùng). Trên tờ khai lấy sau
  cụm "đang có chồng là"/"đang có vợ là".
