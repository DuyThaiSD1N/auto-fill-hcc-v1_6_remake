...
def enrich(fields: list[dict], options: dict | None = None) -> list[dict]:
    ...
    add("TraKQ", "1")
    # Đặc thù eForm cổng React mới (tro-ly): form cấp MỚI (đăng ký lại có form riêng) →
    # loại đăng ký lần đầu; số lượng bản cấp tối thiểu — mặc định tô vàng cho dân tự chỉnh.
