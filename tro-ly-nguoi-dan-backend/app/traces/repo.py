...
async def set_report(request_id: str, kind: str, report: dict) -> None:
    """Mở rộng RIÊNG của tro-ly (kênh sidebar): FE báo kết quả THẬT trên form
    (fill_report: số ô điền được / attach_report: số tệp gắn được) → gắn vào trace.
    Auto-fill không có cột này — bên đó chỉ biết số field trích được."""
