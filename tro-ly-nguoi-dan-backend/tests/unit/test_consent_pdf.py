"""Consent v1.2: entry tự đủ nghĩa (statements/location/acc), lượt đồng ý sinh PDF
...
def test_endpoint_list_consents():
    ...
    docs = [{
        ...
        "version": "1.2", "location": {"province": "Tỉnh Lai Châu", "ward": "Phường Tân Phong"},
